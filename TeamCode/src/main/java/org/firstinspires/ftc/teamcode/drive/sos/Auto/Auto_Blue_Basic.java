...
@Autonomous(name="Auto_Blue_Basic", group="Auto")

public class Auto_Blue_Basic extends LinearOpMode {
    ...
    public void zoneThree() {
        ...
        robot.closeClaw();
        delay(0.5);
        robot.moveDistance(0.75, 0.5);
        delay(0.5);
        robot.strafeInches(-27, 0.5);
        delay(0.5);
